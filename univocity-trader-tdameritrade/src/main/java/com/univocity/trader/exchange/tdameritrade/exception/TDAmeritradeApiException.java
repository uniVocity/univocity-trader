package com.univocity.trader.exchange.tdameritrade.exception;

public class TDAmeritradeApiException extends RuntimeException {
    ...
    public TDAmeritradeApiException(String errType, String errMsg) {
        super(errMsg);
        this.errCode = errType;
    }

    public TDAmeritradeApiException(String errType, String errMsg, Throwable e) {
        super(errMsg, e);
        this.errCode = errType;
    }
