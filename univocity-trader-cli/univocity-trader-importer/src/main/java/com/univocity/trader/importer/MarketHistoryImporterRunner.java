...
public class MarketHistoryImporterRunner {
   public void run() {
      ...
      final String[] currencies = univocityConfiguration.getExchangeCurrencies();
      final String[] pairs = Currencies.getInstance().makePairs(currencies, new String[] { univocityConfiguration.getExchangeReferenceCurrency() });
