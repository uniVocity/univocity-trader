...
public class AroonOscillatorIndicatorTest {
    ...
    public void aroonOscilator() {
        ...
        indicator.accumulate(candles.get(i++));
        indicator.accumulate(candles.get(i++));
        assertEquals(84, indicator.getValue(), 0.00001);

        indicator.accumulate(candles.get(i++));
        assertEquals(80, indicator.getValue(), 0.00001);

        indicator.accumulate(candles.get(i++));
        assertEquals(76, indicator.getValue(), 0.00001);
