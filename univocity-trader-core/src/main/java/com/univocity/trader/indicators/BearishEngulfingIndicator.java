...
public class BearishEngulfingIndicator extends SingleValueIndicator {

    private double value;
    private Candle prev;

    public BearishEngulfingIndicator(TimeInterval interval) {
        super(interval, null);
    }
    ...
    protected boolean process(Candle candle, double value, boolean updating) {
        ...
        } else if (prev.isClosePositive() && !candle.isClosePositive()) {
